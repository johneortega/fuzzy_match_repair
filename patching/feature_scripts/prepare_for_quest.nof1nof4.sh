...
awk -F'\t' {'print $29'} ${train_file} > ${train_file}.successrates
awk -F'\t' {'$29=$30=$31=$32=$33=$34=$35=$36=$37=$39=$40=$41=$42""; print $0'} ${train_file} > ${train_file}.without.successrates
...
awk -F'\t' {'print $29'} ${dev_file} > ${dev_file}.successrates
awk -F'\t' {'$29=$30=$31=$32=$33=$34=$35=$36=$37=$39=$40=$41=$42""; print $0'} ${dev_file} > ${dev_file}.without.successrates

...
awk -F'\t' {'print $3'} ${train_file} > ${train_file}.successrates
awk -F'\t' {'$3=$4=$5=$6=$7=$8=$9=$10""; print $0'} ${train_file} > ${train_file}.without.successrates


### now dev 
gunzip -f ${dev_file}
dev_file=${dev_file%$gz_end}
awk -F'\t' {'print $3'} ${dev_file} > ${dev_file}.successrates
awk -F'\t' {'$3=$4=$5=$6=$7=$8=$9=$10""; print $0'} ${dev_file} > ${dev_file}.without.successrates
...
awk -F'\t' '{print $5}' ${dev_file} > ${dev_sentences}
python process.py $dev_sentences > ${dev_sentences_count}
awk -F'\t' '{print $6}' ${dev_file} > ${dev_sentences_wer}

...
if [ "${alter}" = "esplagomis" ] && [ "${switchtest}" = "" ]; then
	...
	./prepare_for_quest.sh run_global_scenario_${1}_${2}.train.bbandbothgrounding.wer.esplagomis.gz run_global_scenario_${1}_${2}.${runset}.bbandbothgrounding.wer.esplagomis.gz > prepare.out 2>&1
	sleep 10
	...
	gzip -f run_global_scenario_${1}_${2}.train.bbandbothgrounding.wer
	#gzip -f run_global_scenario_${1}_${2}.dev.bbandbothgrounding.wer
	gzip -f run_global_scenario_${1}_${2}.test.bbandbothgrounding.wer
    ## uncomment for a train on 60% fms every time
	...
	./prepare_for_quest.sh run_global_scenario_${1}_${2}.train.bbandbothgrounding.wer.gz run_global_scenario_${1}_${2}.${runset}.bbandbothgrounding.wer.gz > prepare.out 2>&1

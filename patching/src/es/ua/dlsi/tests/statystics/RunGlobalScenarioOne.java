 ...
 */
public class RunGlobalScenarioOne{
...
*/
	...
	try{
        ...
        //    System.err.println(entry.getKey());
            //String test = translations.get("reglamentarios — capital de nivel");
        //}
		ois.close();
		fis.close();
        //System.exit(-1);
...
***************************************/
			...
			if(patchOps.size()>0){
				...
				if(patchOps.size()<MAX_PATCHOPS_SIZE){
                    ...
                    // printing the two lines below will screw up feature gen
                    ...
                    System.err.println(i + "\t" + patchOps.size() +  "\t" + theSPrimeSegment.toString() + "\t" + patchManager.counter);
          ...
          // uncoment to print out distances, this was comented for marco turchi
         // remove marco turchi, just adding for congruence
		 //if(!DO_INTERMEDIATE)

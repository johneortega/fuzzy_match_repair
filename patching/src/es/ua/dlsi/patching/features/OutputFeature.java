 ...
 * @version 0.1
 */
public abstract class OutputFeature{
	protected IntermediateFeature iFeature	= null;
	public  abstract void setFeature(IntermediateFeature iFeature);
	public  boolean equals(Object o){
		if(o == null)        
		   return false;
		if(!(o instanceof OutputFeature)) 
		   return false;
		OutputFeature other = (OutputFeature) o;
		return (other.iFeature == this.iFeature);
	}
	// the function to process the intermediate Feature and output

 ...
 * @version 0.1
 */
public class OutputFeature28 extends OutputFeature{
	public OutputFeature28(){}
	@Override
	...
	public String process(){
		int ed = Segment.EditDistance(super.iFeature.hypothesis, super.iFeature.tPrime, null);
		int maxWords =java.lang.Math.max(super.iFeature.hypothesis.size(), super.iFeature.tPrime.size());
        /*
		if(super.iFeature.tPrime.toString().contains("32011 d 0121")){

		System.out.println("hypo");
		System.out.println(super.iFeature.hypothesis);
		System.out.println("tPrime");
		System.out.println(super.iFeature.tPrime);
		System.out.println(String.valueOf(ed) + " " + String.valueOf(maxWords));

		}
        */
		return String.valueOf(ed) + " " + String.valueOf(maxWords);

 ...
 * feature 38 num of punctuation marks in s'
 * @author John Evan Ortega
 * @version 0.1
 */
public class OutputFeature38 extends OutputFeature{
	public OutputFeature38(){}
	@Override
	...
	public String process(){
		double ret = (double) getpuncmarks(super.iFeature.sPrime.toString());

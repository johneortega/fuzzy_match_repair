 ...
 * Glass box feature 2, feature 8 in count
 * Sum of the length of the patching operators used to build t' divided by the length of t
 * @author John Evan Ortega
 * @version 0.1
 */
public class OutputFeature8 extends OutputFeature{
	public OutputFeature8(){}
	@Override
	...
	public String process(){
		...
		for(PatchOperator patchOp : super.iFeature.operators){
			...
			if(patchOp.isYesNode()){
				sumOpLen+=patchOpSize;
			}
		}
		if(sumOpLen>0 && hypSize>0)
			ret=(double)sumOpLen/hypSize;
		/*
		if(ret>100){
			...
			System.out.println("oplen:" + sumOpLen);
			System.out.println("oplen:" + sumOpLen);
		}
		*/

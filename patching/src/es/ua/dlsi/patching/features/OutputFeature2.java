 ...
 * @version 0.1
 */
public class OutputFeature2 extends OutputFeature{
	public OutputFeature2(){}
	@Override
	...
	public String process(){
		...
		if(tscore==1){
			...
			System.out.println("num yes patch ops:" + numYesPatchOps);
			System.out.println("num no patch ops:" + numNoPatchOps);
			System.out.println("patch ops:\n" + patchOps);
		}
		*/
		return String.valueOf(tscore);

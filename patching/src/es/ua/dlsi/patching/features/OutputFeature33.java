 ...
 * the best oracle for this sentence number
 * requires a file that has per-line (sentence) oracle values
 * 1 0.333
 * 2 0.544 
 * @author John Evan Ortega
 * @version 0.1
 */
public class OutputFeature33 extends OutputFeature{
        String sentfile = "";
	public OutputFeature33(){}
	public OutputFeature33(String sentfile){
	...
	public String process(){
		...
		try(BufferedReader br = new BufferedReader(new FileReader(sentfile))) {
			...
			//sentid is the line number
			System.out.println("This is the sentid: " + super.iFeature.sentid + " this is the lncnt " + lincnt);
		    	if(lincnt==super.iFeature.sentid){
				return (line);
			}
			lincnt++;
		    }

 ...
 * feature 39 num of punctuation marks in hypothesis
 * @author John Evan Ortega
 * @version 0.1
 */
public class OutputFeature39 extends OutputFeature{
	public OutputFeature39(){}
	@Override
	...
	public String process(){
		double ret = (double)getpuncmarks(super.iFeature.hypothesis.toString());
		return String.valueOf(ret);
	}
	private int getpuncmarks(String text){
		int numPuncMarks = 0;
		for(int i=0; i<text.length(); i++){
		    char currentChar = text.charAt(i);
		    // check for a punctuation mark (,."!?;:)

 ...
 * @version 0.1
 */
public class OutputFeature1 extends OutputFeature{
	public OutputFeature1(){}
	@Override
	...
	public String process(){
		...
		double sscore=TranslationMemory.GetScoreNew(super.iFeature.sPrime, super.iFeature.s, talignment);
		/*
		if(sscore==1 || sscore < 0.60)
			System.out.println(sscore);
		*/
		//System.out.println(super.iFeature.sPrime);

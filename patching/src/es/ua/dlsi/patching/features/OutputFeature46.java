 ...
 * number of edits to t' from t
 * @author John Evan Ortega
 * @version 0.1
 */
public class OutputFeature46 extends OutputFeature{
	public OutputFeature46(){}
	@Override
	...
	public String process(){
		int ed = Segment.EditDistance(super.iFeature.t, super.iFeature.tPrime, null);

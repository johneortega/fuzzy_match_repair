...
def save_feature_pic(forest,X):
    ...
    tree_feature_names = ['BB10','BB11','BB12','BB13','BB14','BB15','GB1','GB2','GB3','GB4','GB5','GB6','GB7','GB8','GB9','GB10','GB11','GB12', 'GB14','GB15','GB16','BB1','BB2','BB4','BB5','GB18','GB17','BB6','BB9','BB7','BB8','BB3']
    #tree_feature_names = ['BB10','BB11','BB12','BB13','BB14','BB15','GB1','GB2','GB3','GB4','GB5','GB6','GB7','GB8','GB9','GB10','GB11','GB12','tsize', 'GB14','GB15','GB16','BB1','BB2','BB4','BB5','GB18','GB17','BB6','BB9','BB7','BB8','BB3']
    ...
    #print("tree feature index" + tree_feature_names[32])
    print("tree feature index" + tree_feature_names[31])
    final_tree_names=[]
...
def save_learning_curve(estimator, title, X, y, ylim=None, cv=None,
    ...
    '''
    # felipe asked for black and dashed/solid lines
    plt.fill_between(train_sizes, train_scores_mean - train_scores_std,
                     train_scores_mean + train_scores_std, alpha=0.1,
                     color="black")
    plt.fill_between(train_sizes, test_scores_mean - test_scores_std,
    ...
    plt.plot(train_sizes, train_scores_mean, 'o-', color="black",
             label="Training score")
    plt.plot(train_sizes, test_scores_mean, 'o-', color="black", linestyle='dashed',
             label="Cross-validation score")
    #plt.legend(loc="best")
    plt.savefig('learning_curve.png',bbox_inches = "tight")
    log.info("Saving learning curve and exiting")
    sys.exit()
...
def fit_predict(config, X_train, y_train, X_test=None, y_test=None, ref_thd=None):
    ...
    #### below is for etr machine learning validation curve plot 
    #title = "Learning Curves (ETR)"
    # Cross validation with 100 iterations to get smoother mean test and train
    # score curves, each time with 20% data randomly selected as a validation set.
    #cv = cross_validation.ShuffleSplit(X_train.shape[0], n_iter=10,
    #                               test_size=0.2, random_state=0)
    #save_learning_curve(estimator, title, X_train, y_train, (0.7, 1.01), cv=cv, n_jobs=4)

...
#    cp model_file_${1}/model_file_${2}fms_etr_nofs.esplagomis_*.pkl model_file.pkl
...
if [ "${alter}" = "esplagomis" ] && [ "${switchtest}" = "" ]; then
	gzip -f run_global_scenario_${1}_${2}.train.bbandbothgrounding.nobl1bl2bl4bl5bl7bl8.wer.esplagomis
	gzip -f run_global_scenario_${1}_${2}.dev.bbandbothgrounding.nobl1bl2bl4bl5bl7bl8.wer.esplagomis
	gzip -f run_global_scenario_${1}_${2}.test.bbandbothgrounding.nobl1bl2bl4bl5bl7bl8.wer.esplagomis
	...
	./prepare_for_quest.sh run_global_scenario_${1}_${2}.train.bbandbothgrounding.nobl1bl2bl4bl5bl7bl8.wer.esplagomis.gz run_global_scenario_${1}_${2}.${runset}.bbandbothgrounding.nobl1bl2bl4bl5bl7bl8.wer.esplagomis.gz > prepare.out 2>&1
	sleep 10
	awk -F'\t' {'print $30'} run_global_scenario_${1}_${2}.${runset}.bbandbothgrounding.nobl1bl2bl4bl5bl7bl8.wer.esplagomis | sort | uniq > grep1.o 
elif [ "${switchtest}" = "switchtest" ]; then
    echo "trying switchtest"
    sleep 100
	gzip -f run_global_scenario_${1}_${2}.train.bbandbothgrounding.wer.esplagomis
	#gzip -f run_global_scenario_${1}_${2}.dev.bbandbothgrounding.wer.esplagomis
	gzip -f run_global_scenario_${1}_${2}.test.bbandbothgrounding.wer.esplagomis
	#gzip -f run_global_scenario_${1}_${2}.dev.bbandbothgrounding.wer
	gzip -f run_global_scenario_${1}_${2}.test.bbandbothgrounding.wer
    ## uncomment for a train on 60% fms every time
	...
	./prepare_for_quest.sh run_global_scenario_${1}_${2}.train.bbandbothgrounding.wer.esplagomis.gz run_global_scenario_${1}_${2}.${runset}.bbandbothgrounding.wer.gz > prepare.out 2>&1
	sleep 10
	awk -F'\t' {'print $33'} run_global_scenario_${1}_${2}.${runset}.bbandbothgrounding.wer | sort | uniq > grep1.o 
else
	gzip -f run_global_scenario_${1}_${2}.train.bbandbothgrounding.nobl1bl2bl4bl5bl7bl8.wer
	gzip -f run_global_scenario_${1}_${2}.dev.bbandbothgrounding.nobl1bl2bl4bl5bl7bl8.wer
	gzip -f run_global_scenario_${1}_${2}.test.bbandbothgrounding.nobl1bl2bl4bl5bl7bl8.wer
    ## uncomment for a train on 60% fms every time
	...
	./prepare_for_quest.sh run_global_scenario_${1}_${2}.train.bbandbothgrounding.nobl1bl2bl4bl5bl7bl8.wer.gz run_global_scenario_${1}_${2}.${runset}.bbandbothgrounding.nobl1bl2bl4bl5bl7bl8.wer.gz > prepare.out 2>&1

	sleep 10
	awk -F'\t' {'print $30'} run_global_scenario_${1}_${2}.${runset}.bbandbothgrounding.nobl1bl2bl4bl5bl7bl8.wer | sort | uniq > grep1.o 
fi
...
model_file="model_file_nobl1bl2bl4bl5bl7bl8_${2}fms_Etr_test.nofs.${alter}_${tmwer}_${fmrwer}_${orawer}_${successrate}.pkl"

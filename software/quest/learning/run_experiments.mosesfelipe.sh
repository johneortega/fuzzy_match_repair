...
#    cp model_file_${1}_no_bb1_or_bb4/model_file_${2}fms_Etr.nofs.esplagomis_*.pkl model_file.pkl
#    cp model_file_${1}/model_file_60fms_etr_nofs.esplagomis_*.pkl model_file.pkl
#else
#    cp model_file_${1}_no_bb1_or_bb4/model_file_${2}fms_Etr.nofs.wer_*.pkl model_file.pkl
#    cp model_file_${1}/model_file_60fms_etr_nofs.wer_*.pkl model_file.pkl
#fi


if [ "${alter}" = "esplagomis" ] && [ "${switchtest}" = "" ]; then
	gzip -f run_global_scenario_${1}_${2}.train.mosesfelipe.bbandbothgrounding.wer.esplagomis
	#gzip -f run_global_scenario_${1}_${2}.dev.mosesfelipe.mosesfelipe.bbandbothgrounding.wer.esplagomis
	gzip -f run_global_scenario_${1}_${2}.test.mosesfelipe.bbandbothgrounding.wer.esplagomis
    ## uncomment for a train on 60% fms every time
	#./prepare_for_quest.sh run_global_scenario_${1}_60.train.mosesfelipe.bbandbothgrounding.wer.esplagomis.gz run_global_scenario_${1}_${2}.${runset}.mosesfelipe.bbandbothgrounding.wer.esplagomis.gz > prepare.out 2>&1
	./prepare_for_quest.sh run_global_scenario_${1}_${2}.train.mosesfelipe.bbandbothgrounding.wer.esplagomis.gz run_global_scenario_${1}_${2}.${runset}.mosesfelipe.bbandbothgrounding.wer.esplagomis.gz > prepare.out 2>&1
	sleep 10
	awk -F'\t' {'print $33'} run_global_scenario_${1}_${2}.${runset}.mosesfelipe.bbandbothgrounding.wer.esplagomis | sort | uniq > grep1.o 
elif [ "${switchtest}" = "switchtest" ]; then
    echo "trying switchtest"
    sleep 100
	gzip -f run_global_scenario_${1}_${2}.train.mosesfelipe.bbandbothgrounding.wer.esplagomis
	#gzip -f run_global_scenario_${1}_${2}.dev.mosesfelipe.bbandbothgrounding.wer.esplagomis
	gzip -f run_global_scenario_${1}_${2}.test.mosesfelipe.bbandbothgrounding.wer.esplagomis
	#gzip -f run_global_scenario_${1}_${2}.dev.mosesfelipe.bbandbothgrounding.wer
	gzip -f run_global_scenario_${1}_${2}.test.mosesfelipe.bbandbothgrounding.wer
    ## uncomment for a train on 60% fms every time
	#./prepare_for_quest.sh run_global_scenario_${1}_60.train.mosesfelipe.bbandbothgrounding.wer.esplagomis.gz run_global_scenario_${1}_${2}.${runset}.mosesfelipe.bbandbothgrounding.wer.gz > prepare.out 2>&1
	./prepare_for_quest.sh run_global_scenario_${1}_${2}.train.mosesfelipe.bbandbothgrounding.wer.esplagomis.gz run_global_scenario_${1}_${2}.${runset}.mosesfelipe.bbandbothgrounding.wer.gz > prepare.out 2>&1
	sleep 10
	awk -F'\t' {'print $33'} run_global_scenario_${1}_${2}.${runset}.mosesfelipe.bbandbothgrounding.wer | sort | uniq > grep1.o 
else
	gzip -f run_global_scenario_${1}_${2}.train.mosesfelipe.bbandbothgrounding.wer
	#gzip -f run_global_scenario_${1}_${2}.dev.mosesfelipe.bbandbothgrounding.wer
	gzip -f run_global_scenario_${1}_${2}.test.mosesfelipe.bbandbothgrounding.wer
    ## uncomment for a train on 60% fms every time
	#./prepare_for_quest.sh run_global_scenario_${1}_60.train.mosesfelipe.bbandbothgrounding.wer.gz run_global_scenario_${1}_${2}.${runset}.mosesfelipe.bbandbothgrounding.wer.gz > prepare.out 2>&1
	./prepare_for_quest.sh run_global_scenario_${1}_${2}.train.mosesfelipe.bbandbothgrounding.wer.gz run_global_scenario_${1}_${2}.${runset}.mosesfelipe.bbandbothgrounding.wer.gz > prepare.out 2>&1
...
echo "this is successrate: ${successrate}"
...
#model_file="model_file_${2}fms_Etr_test.nofs.${alter}_${tmwer}_${fmrwer}_${orawer}_${successrate}.pkl"
#model_file="model_file_${2}fms_Etr_test.nofs.${alter}_${tmwer}_${fmrwer}_${orawer}_${successrate}.pkl"

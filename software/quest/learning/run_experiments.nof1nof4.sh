...
if [ "${alter}" = "esplagomis" ]; then
    #cp model_file_${1}_no_bb1_or_bb4/model_file_${2}fms_Etr_nof1nof4.nofs.esplagomis_*.pkl model_file.pkl
    cp model_file_${1}_no_bb1_or_bb4/model_file_60fms_Etr_nof1nof4.nofs.esplagomis_*.pkl model_file.pkl
else
    #cp model_file_${1}_no_bb1_or_bb4/model_file_${2}fms_Etr_nof1nof4.nofs.wer_*.pkl model_file.pkl
    cp model_file_${1}_no_bb1_or_bb4/model_file_60fms_Etr_nof1nof4.nofs.wer_*.pkl model_file.pkl
fi

if [ "${alter}" = "esplagomis" ] && [ "${switchtest}" = "" ]; then
	gzip -f run_global_scenario_${1}_${2}.train.bbandbothgrounding.nof1nof4.wer.esplagomis
	#gzip -f run_global_scenario_${1}_${2}.dev.bbandbothgrounding.nof1nof4.wer.esplagomis
	gzip -f run_global_scenario_${1}_${2}.test.bbandbothgrounding.nof1nof4.wer.esplagomis
    ## uncomment for a train on 60% fms every time
	./prepare_for_quest.nof1nof4.sh run_global_scenario_${1}_60.train.bbandbothgrounding.nof1nof4.wer.esplagomis.gz run_global_scenario_${1}_${2}.${runset}.bbandbothgrounding.nof1nof4.wer.esplagomis.gz > prepare.out 2>&1
	#./prepare_for_quest.nof1nof4.sh run_global_scenario_${1}_${2}.train.bbandbothgrounding.nof1nof4.wer.esplagomis.gz run_global_scenario_${1}_${2}.${runset}.bbandbothgrounding.nof1nof4.wer.esplagomis.gz > prepare.out 2>&1
	sleep 10
	awk -F'\t' {'print $31'} run_global_scenario_${1}_${2}.${runset}.bbandbothgrounding.nof1nof4.wer.esplagomis | sort | uniq > grep1.o 
elif [ "${switchtest}" = "switchtest" ]; then
	...
	#gzip -f run_global_scenario_${1}_${2}.dev.bbandbothgrounding.nof1nof4.wer.esplagomis
	gzip -f run_global_scenario_${1}_${2}.test.bbandbothgrounding.nof1nof4.wer.esplagomis
	#gzip -f run_global_scenario_${1}_${2}.dev.bbandbothgrounding.nof1nof4.wer
	gzip -f run_global_scenario_${1}_${2}.test.bbandbothgrounding.nof1nof4.wer
    ## uncomment for a train on 60% fms every time
	./prepare_for_quest.nof1nof4.sh run_global_scenario_${1}_60.train.bbandbothgrounding.nof1nof4.wer.esplagomis.gz run_global_scenario_${1}_${2}.${runset}.bbandbothgrounding.nof1nof4.wer.gz > prepare.out 2>&1
	#./prepare_for_quest.nof1nof4.sh run_global_scenario_${1}_${2}.train.bbandbothgrounding.nof1nof4.wer.esplagomis.gz run_global_scenario_${1}_${2}.${runset}.bbandbothgrounding.nof1nof4.wer.gz > prepare.out 2>&1
	sleep 10
	awk -F'\t' {'print $31'} run_global_scenario_${1}_${2}.${runset}.bbandbothgrounding.nof1nof4.wer | sort | uniq > grep1.o 
else
	gzip -f run_global_scenario_${1}_${2}.train.bbandbothgrounding.nof1nof4.wer
	#gzip -f run_global_scenario_${1}_${2}.dev.bbandbothgrounding.nof1nof4.wer
	gzip -f run_global_scenario_${1}_${2}.test.bbandbothgrounding.nof1nof4.wer
    ## uncomment for a train on 60% fms every time
	./prepare_for_quest.nof1nof4.sh run_global_scenario_${1}_60.train.bbandbothgrounding.nof1nof4.wer.gz run_global_scenario_${1}_${2}.${runset}.bbandbothgrounding.nof1nof4.wer.gz > prepare.out 2>&1
	#./prepare_for_quest.nof1nof4.sh run_global_scenario_${1}_${2}.train.bbandbothgrounding.nof1nof4.wer.gz run_global_scenario_${1}_${2}.${runset}.bbandbothgrounding.nof1nof4.wer.gz > prepare.out 2>&1
...
#model_file="model_file_${2}fms_Etr_test_nof1nof4.nofs.${alter}_${tmwer}_${fmrwer}_${orawer}_${successrate}.pkl"
model_file="model_file_${2}fms_Etr_nof1nof4.nofs.${alter}_${tmwer}_${fmrwer}_${orawer}_${successrate}.pkl"
